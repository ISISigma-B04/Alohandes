...
public class Habitacion extends Propiedad implements VOHabitacion {
     ...
     *
     */
    public Habitacion(long pId, int pCapacidad, double pTamanio, double pPrecio, String pFecha, int pDiasR, int pPiso,
                      boolean pIndiv, String pEsquema, int pTipo, long pOperador) {
    ...
    public String toString() {
        return "Habitacion [id=" + super.getId() + ", capacidad=" + super.getCapacidad() +
               ...
               ", habilitada= " + boolToInt(super.isHabilitada()) + ", individual=" + boolToInt(
                individual) + ", esquema=" + esquema + ", tipo=" + tipo + ", operador=" + operador +
