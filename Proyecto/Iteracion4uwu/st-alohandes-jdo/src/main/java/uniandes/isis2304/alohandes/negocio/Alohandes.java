 ...
 */
@SuppressWarnings({"unused", "ConstantValue", "UnusedReturnValue"}) public class Alohandes {
    /* ****************************************************************
     * 			Constantes
     *****************************************************************/
    /**
     ...
     */
    private static final Logger log = Logger.getLogger(Alohandes.class.getName());
    ...
    public List<VOUsuario> darVOUsuarios() {
        ...
        List<VOUsuario> voUsuario = new LinkedList<>(pp.darUsuarios());
    ...
    public List<VOCliente> darVOTCliente() {
        ...
        List<VOCliente> voCliente = new LinkedList<>(pp.darCliente());
     ...
     */
    public Operador adicionarOperador(String logIn, String tipoId, String numeroId, String relacionU, int numeroRNT,
        ...
        Operador operador = pp.adicionarOperador(numeroId, logIn, tipoId, relacionU, numeroRNT, vencimientoRNT,
                                                 registroSuperTurismo, vencimientoRegistroSuperTurismo, categoria,
                                                 direccion, horaApertura, horaCierre, tiempoMinimo, gananciaAnioActual,
                                                 gananciAnioCorrido, habitaciones, apartamentos);
    ...
    public List<VOOperador> darVOOperadores() {
        ...
        List<VOOperador> voOperador = new LinkedList<>(pp.darOperadores());
     ...
     */
    public Propiedad adicionarPropiedad(long pID, int pCapacidad, double pTamanio, double pPrecio, String pFecha,
                                        int pDiasR, int pPiso) {
    ...
    public List<VOPropiedad> darVOPropiedad() {
        ...
        List<VOPropiedad> voPropiedad = new LinkedList<>(pp.darPropiedades());
    ...
    public ArrayList<Habitacion> darHabitacionesDisponibles() {
        ...
        return (ArrayList<Habitacion>) pp.darHabitacionesDisponibles();
    }
    ...
    public List<VOApartamento> darVOApartamento() {
        ...
        List<VOApartamento> voApartamento = new LinkedList<>(pp.darApartamentos());
    ...
    public ArrayList<Apartamento> darApartamentosDisponibles() {
        log.info("Dar información de apartamentos disponibles: ");
        return (ArrayList<Apartamento>) pp.darApartamentosDisponibles();
    }
    ...
    public Habitacion adicionarHabitacion(long pId, int pCapacidad, double pTamanio, double pPrecio, String pFecha,
        ...
        Habitacion habitacion = pp.adicionarHabitacion(pId, pCapacidad, pTamanio, pPrecio, pFecha, pDiasR, pPiso,
                                                       pIndiv, pEsquema, pTipo, pOperador);
    ...
    public List<VOHabitacion> darVOHabitacion() {
        ...
        List<VOHabitacion> voHabitacion = new LinkedList<>(pp.darHabitaciones());
...
//		String finCancelacionOportuna = dateFormat.format(fco);
        ...
        Reserva reserva = pp.adicionarReserva(pfechaInicio, pfechaFin, personas, finCancelacionOportuna,
                                              porcentajeAPagar, montoTotal, idProp);
    ...
    public List<VOReserva> darVOReservas() {
        ...
        List<VOReserva> voReservas = new LinkedList<>(pp.darReservas());
     ...
     * @return El objeto Reserva adicionado. null si ocurre alguna Excepción
     */
    public ReservaColectiva adicionarReservaColectiva(long pId, int pCantidad, String pTipo, String pInicio,
                                                      int pDuracion) {
    ...
    public List<VOReservaColectiva> darVOReservaColectiva() {
        log.info("Generando los VO de Reservas");
        List<VOReservaColectiva> voReservas = new LinkedList<>(pp.darRerservasColectivas());
    ...
    public List<VOServicio> darVOServicio() {
        ...
        List<VOServicio> voServicio = new LinkedList<>(pp.darServicio());
    ...
    public List<Object[]> darFuncionamientoData() {
        ...
        List<Object[]> lista = pp.darFuncionamientoData();
    ...
    public List<Object[]> consumoNO(String orden, String FI, String FF, String id) {
        ...
        log.info(" Consumo NO  ");
        List<Object[]> lista = pp.consumoNO(orden, FI, FF, id);
    ...
    public List<Object[]> consumoSI(String orden, String FI, String FF, String id) {
        ...
        log.info(" Consumo SI  ");
        List<Object[]> lista = pp.consumoSI(orden, FI, FF, id);
