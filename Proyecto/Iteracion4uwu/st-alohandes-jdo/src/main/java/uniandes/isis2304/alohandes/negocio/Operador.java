...
public class Operador extends Usuario implements VOOperador {
     ...
     */
    public Operador(String logIn, String tipoId, String numeroId, String relacionU, int numero_RNT,
                    String vencimiento_RNT, String registroSuperTurismo, String vencimientoRegistroSuperTurismo,
                    String categoria, String direccion,
                    String horaApertura, String horaCierre, int tiempo_Minimo, double gananciaAnioActual,
    ...
    public void agregarHabitacion(int pID, int pCapacidad, double pTamanio, double pPrecio, String pFecha, int pDiasR,
                                  int pPiso, boolean pIndiv, String pEsquema, int pTipo, long pOperador) {
        Habitacion nuevo = new Habitacion(pID, pCapacidad, pTamanio, pPrecio, pFecha, pDiasR, pPiso, pIndiv, pEsquema,
                                          pTipo, pOperador);
    ...
    public void agregarApartamento(int pID, int pCapacidad, double pTamanio, double pPrecio, String pFecha, int pDiasR,
                                   int pPiso, boolean pAmueblado, int pHabitaciones, String pDMenaje, int pVenceSeguro,
                                   String pDSeguro) {
        Apartamento nuevo = new Apartamento(pID, pCapacidad, pTamanio, pPrecio, pFecha, pDiasR, pPiso, pAmueblado,
                                            pHabitaciones, pDMenaje, pVenceSeguro, pDSeguro, this.getNumeroId());
