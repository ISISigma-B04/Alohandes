...
public class Apartamento extends Propiedad implements VOApartamento {
    ...
    public Apartamento(long pID, int pCapacidad, double pTamanio, double pPrecio, String pFecha, int pDiasR, int pPiso,
                       boolean pAmueblado, int pHabitaciones, String pDMenaje, int pVenceSeguro, String pDSeguro,
                       long pOperador) {
    ...
    public String toString() {
        return "Apartamento [id=" + super.getId() + ", capacidad=" + super.getCapacidad() +
               ...
               ", habilitada=" + boolToInt(super.isHabilitada()) + ", amueblado=" + boolToInt(
                amueblado) + ", habitaciones=" + habitaciones + ", descripcionMenaje=" + descripcionMenaje +
