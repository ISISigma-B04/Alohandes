...
class SQLApartamento {
     ...
     */
    public long adicionarApartamento(PersistenceManager pm, long idApt, boolean am, String desMenaje,
                                     String descrSeguro, int venceSeguro, long idOp) {
        Query q = pm.newQuery(SQL,
                              "INSERT INTO " + pa.darTablaApartamento() + "(id, amueblado, habitaciones, descripcion_menaje, descripcion_seguro, tiene_seguro) values ( ?, ?, ?, ?,?,?)");
