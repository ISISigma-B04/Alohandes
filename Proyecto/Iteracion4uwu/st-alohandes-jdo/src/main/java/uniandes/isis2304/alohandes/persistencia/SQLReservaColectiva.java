...
public class SQLReservaColectiva {
     ...
     */
    public long adicionarReservaColectiva(PersistenceManager pm, long id, String fechaInicio, int duracion,
                                          int cantidad, String tipo) {

        Query q = pm.newQuery(SQL,
                              "INSERT INTO " + pp.darTablaReservaColectiva() + "(id, fechaInicio, duracion, cantidad, tipoAlojamiento)"
                              + " values (?, ?, ?, ?, ?)");
